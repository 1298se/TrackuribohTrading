...
scheduler.add_job(fetch_all_near_mint_card_listing_data, id="fetch_all_near_mint_listing", trigger='cron', hour='0,6,12,18')
...
def job_listener(event):
    if event.exception:
        ...
        # Check if the completed job is job1, then schedule job2
